...
## 🏢 SUPER_ADMIN 대시보드 (전체 관리자)

<div align="center">
  <img src="https://github.com/user-attachments/assets/6b3330b6-02e7-44e2-87dd-25e4f10fa250" width="48%" />
  <img src="https://github.com/user-attachments/assets/1de23956-f25c-438b-8ede-76c34fddf1de" width="48%" />
</div>
...
- 전체 매장의 운영 상태를 한눈에 확인할 수 있는 관리자 대시보드
- 매장을 **운영 / 오픈 예정 / 폐점 / 오픈 미정** 상태로 구분
- 지역별 매장 분포 및 관리자 수를 함께 제공
- 오픈일 미정 매장을 별도로 표시하여 운영 리스크 관리

---

### 설계 의도

- 상태값을 프론트에서 계산하지 않고 **서버에서 일괄 처리**하여 데이터 정합성 유지
- 단순 리스트가 아닌 **운영 판단을 위한 요약형 대시보드 구조**로 설계
- 관리자가 빠르게 현황을 파악할 수 있도록 **시각적 정보(차트, 배지)** 중심 UI 구성

---

### 데이터 흐름

로그인 → JWT 인증 → role = SUPER_ADMIN  
→ 매장 / 관리자 데이터 조회 → 대시보드 렌더링
